...
class F1SeasonApp:
    ...
    def register_team_for_season(self, team_name: str, budget: int):
        if not team_name == "Red Bull" and not team_name == "Mercedes":
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int):
        ...
        faster_team = "Red Bull" if red_bull_pos < mercedes_pos else "Mercedes"
        ...
        return (f"Red Bull: {self.red_bull_team.calculate_revenue_after_race(red_bull_pos)}."
                ...
                f" {faster_team} is ahead at the {race_name} race.")
